...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var options = ["Bottom to Top", "Top to Bottom"];
  sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.getInputFromUser("Would you like the text styles as an Array or Object", {
...
function sequenceLayers(reverseLayers) {
  ...
  pages.map(function (page) {
    ...
    var artboards = layers.filter(function (layer) {
